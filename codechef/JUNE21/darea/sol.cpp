...
signed main()
{
    ...
    while (t--)
    {
        ...
        vector<point> p_s(n), sorted_x, sorted_y;
        ...
        // for (int i = 0; i < n;i++){
        //     cout << sorted_y[i].x << " " << sorted_y[i].y << endl;
        // }
        ...
        // for (auto it = down_r.begin(); it != down_r.end(); ++it)
        // {
        ...
        for (auto p : p_s)
        {
            ...
            it = upper_bound(sorted_y.begin(), sorted_y.end(), p,cmp2);
            if (it == sorted_y.end())
                down = p;
            else
                down = *it;
